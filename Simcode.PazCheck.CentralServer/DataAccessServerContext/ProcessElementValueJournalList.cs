...
namespace Simcode.PazCheck.CentralServer
{
    ...
    public class ProcessElementValuesJournalList : ElementListBase<ProcessElementValuesJournalListItem>
	{
        ...
        public ProcessElementValuesJournalList(DataAccessServerWorkerBase dataAccessServerWorker, ServerContext serverContext, uint listClientAlias, CaseInsensitiveOrderedDictionary<string?> listParams)
        ...
        protected override List<Ssz.Utils.DataAccess.AliasResult> OnAddElementListItemsToList(List<ProcessElementValuesJournalListItem> elementListItems)
        {
