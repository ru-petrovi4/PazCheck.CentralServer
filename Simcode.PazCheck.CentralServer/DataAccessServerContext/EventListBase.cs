...
namespace Simcode.PazCheck.CentralServer
{
    ...
    public class EventListBase : ServerListRoot
    {
        ...
        public EventListBase(DataAccessServerWorkerBase dataAccessServerWorker, ServerContext serverContext, uint listClientAlias, CaseInsensitiveOrderedDictionary<string?> listParams)
