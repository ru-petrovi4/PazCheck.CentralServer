...
namespace Simcode.PazCheck.CentralServer
{
    ...
    public class ProcessEventList : EventListBase
    {
        ...
        public ProcessEventList(DataAccessServerWorkerBase dataAccessServerWorker, ILogger logger, ServerContext serverContext, uint listClientAlias, CaseInsensitiveOrderedDictionary<string?> listParams)
            : base(dataAccessServerWorker, serverContext, listClientAlias, listParams)
        {
            ...
            ((DataAccessServerWorker)ServerContext.ServerWorker).ProcessEventMessageNotification += OnProcessEventMessageNotification;
        ...
        public override List<Ssz.Utils.DataAccess.EventIdResult> AckAlarms(string operatorName, string comment,
                                                               IEnumerable<Ssz.Utils.DataAccess.EventId> eventIdsToAck)
        {
            ...
            return eventIdsToAck.Select(e => new Ssz.Utils.DataAccess.EventIdResult { StatusCode = (uint)StatusCode.OK, EventId = e }).ToList();
        }
