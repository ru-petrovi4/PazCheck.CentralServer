...
namespace Simcode.PazCheck.CentralServer.Presentation
{
    public class ProjectConverter : JsonConverter<Project>
    {
            ...
            while (reader.Read() && !_cancellationToken.IsCancellationRequested)
            {
                ...
                switch (propName)
                {
                    case "Name":
                        ...
                        break;
                    case "Descr":
                        project.Descr = reader.GetString();
                        progress++;
                        break;
                    case "Tags":
                    ...
                    case "Causes":
                        ...
                        break;
                    case "Diagrams":
                        project.Diagrams = JsonSerializer.Deserialize<List<Diagram>>(ref reader, options);
        ...
        public override void Write(Utf8JsonWriter writer, Project project, JsonSerializerOptions options)
        {
            ...
            writer.WriteString("Descr", project.Descr);
            ...
            JsonSerializer.Serialize(writer, project.Diagrams, options);
