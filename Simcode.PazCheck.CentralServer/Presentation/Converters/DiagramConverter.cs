...
{
    public class DiagramConverter : JsonConverter<Diagram>
    {
        public override Diagram Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            while (reader.Read())
            {
                ...
                switch (propName)
                {
                    case "Name": diagram.Name = reader.GetString();
                        break;
                    case "Causes":
        ...
        public override void Write(Utf8JsonWriter writer, Diagram diagram, JsonSerializerOptions options)
        {
            writer.WriteStartObject();
            writer.WriteString("Name", diagram.Name);
            diagram.MapKeys();
